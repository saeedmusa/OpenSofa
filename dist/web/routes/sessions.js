...
import { success, error, sessionToSummary, sessionToDetail, } from '../types.js';
import { createLogger } from '../../utils/logger.js';
const log = createLogger('web:routes:sessions');
export const createSessionsRoutes = (deps) => {
    const app = new Hono();
    ...
    app.post('/', async (c) => {
        ...
        try {
            ...
            sessionManager.createSession(name, dir, agent, model || '');
