...
export class ScreenshotService {
  ...
  private overrides?: ScreenshotServiceOverrides;
   ...
   */
  private static readonly MAX_SCREENSHOT_LINES = 60;
   ...
   */
  async renderText(text: string): Promise<Buffer> {
  ...
  private capturePane(port: number): string {
